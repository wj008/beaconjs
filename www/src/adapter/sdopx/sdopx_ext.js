...
//注册资源引用
sdopx_1.Sdopx.registerPlugin('pagebar', function (params, out, sdopx) {
    if (!sdopx.context) {
        return;
    }
    let config = beacon_1.Beacon.getConfig('pagebar:*') || {};
    if (params.data === void 0 || !beacon_1.Beacon.isObject(params.data)) {
    ...
    if (config.show_input == 1) {
        ...
        let id = beacon_1.Beacon.uuid(10);
