...
export class Config {
    ...
    public constructor(dirname) {
        this._dirname = dirname;
    }

    public setDir(dirname) {
        this._dirname = dirname;
    }
    ...
    //加载配置文件
    public  load(name, filepath = null) {
        if (this._names[name] !== void 0) {
            return this._names[name];
        }
        let that = this;
        let _loadFilepath = function (name, filepath: string) {
    ...
    public gload(name, filepath = null) {
