...
var Beacon = (function (_super) {
    ...
    Beacon.run = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var context, Route, args, ctlClass, ctlobj, act, isInit, e_1, e_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        isInit = false;
                        if (!(ctlobj[act] && Beacon.isFunction(ctlobj[act]))) return [3 /*break*/, 12];
                        _a.label = 3;
                    case 3:
                        _a.trys.push([3, 7, 8, 11]);
                        if (!(ctlobj.init && Beacon.isFunction(ctlobj.init))) return [3 /*break*/, 5];
                        return [4 /*yield*/, ctlobj.init()];
                    case 4:
                        _a.sent();
                        isInit = true;
                        _a.label = 5;
                    case 5: return [4 /*yield*/, ctlobj[act]()];
                    case 6:
                        _a.sent();
                        return [3 /*break*/, 11];
                    case 7:
                        ...
                        throw e_1;
                    case 8:
                        if (!(isInit && ctlobj.finish && Beacon.isFunction(ctlobj.finish))) return [3 /*break*/, 10];
                        return [4 /*yield*/, ctlobj.finish()];
                    case 9:
                        _a.sent();
                        _a.label = 10;
                    case 10:
                    ...
                    case 14:
                        e_2 = _a.sent();
                        Beacon.displayError(context, 500, e_2);
                        return [2 /*return*/];
