...
export class PNGImage {
    ...
    public constructor(width, height, depth, backgroundColor = 'transparent') {
        this.width = width;
        this.height = height;
        this.depth = depth;
    ...
    public color(red, green, blue, alpha) {
    ...
    public setBuffer(lineIndex, color) {
        this.buffer[lineIndex] = color;
    }
}